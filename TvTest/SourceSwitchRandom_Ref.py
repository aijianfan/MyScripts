...
if __name__ == '__main__':
    ...
    TvSource(dsn).setUp()
    loop = 1
    sourceList = ['atv','dtv','hdmi1','hdmi2','hdmi3','cvbs']
    ...
    while True:
        ...
        for item in sourceList:
            if item == 'atv':
                TvSource(dsn).test_play_atv(random.randint(5,10))
            elif item == 'dtv':
                TvSource(dsn).test_play_dtv(random.randint(5,10))
            elif item == 'hdmi1':
                TvSource(dsn).test_play_hdmi1(random.randint(5,10))
            elif item == 'hdmi2':
                TvSource(dsn).test_play_hdmi2(random.randint(5,10))
            elif item == 'hdmi3':
                TvSource(dsn).test_play_hdmi3(random.randint(5,10))
            else:
                TvSource(dsn).test_play_cvbs(random.randint(5,10))
